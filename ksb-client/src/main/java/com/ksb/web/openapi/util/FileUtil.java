...
//                throw new AppException(AppExceptionEnum.IMAGE_TYPE_ERROR);
	...
	public static String getImagePath(){
		String date = DateUtil.convertDateToString(new Date(), pattern);
		long snowid = UniqueIDHolder.getIdWorker().nextId(32);
	...
	public static  String getImageUrl(String imageId) {
		...
		String oldImgPath = MessageManager.getString("IMAGE_URL");
		...
		String newImgPath = MessageManager.getString("IMAGE_URL_NEW");
